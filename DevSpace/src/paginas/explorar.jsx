...
const GROUPS = [
  {
    ...
    posts: [
      ...
      { user: "Rafael Lima", handle: "rafaellima", text: "Ainda reviso tudo que a IA gera, mas ela virou ótimo ponto de partida pra boilerplate." },
      { user: "Bianca Reis", handle: "biancareis", text: "Uso mais pra documentação do que pra lógica de negócio, prefiro escrever a parte crítica sozinha." },
      { user: "Thiago Nunes", handle: "thiagonunes", text: "Depender demais de IA pra debugar me fez perder o costume de ler stack trace com calma." },
      { user: "Camila Dias", handle: "camiladias", text: "O autocomplete ajudou muito na curva de aprendizado quando comecei numa stack nova." },
      { user: "Marina Alencar", handle: "marinaalencar", text: "Fine-tuning me deu resultado melhor que prompt gigante pra tarefas repetitivas do time." },
      { user: "Bruno Tavares", handle: "brunotavares", text: "IA ainda erra muito em código legado, prefiro usar só em projeto novo." },
      { user: "Rodrigo Vasconcelos", handle: "rodrigovasco", text: "Automatizei geração de changelog com IA e ninguém mais reclama de esquecer de atualizar." },
      { user: "Isabela Fontes", handle: "isabelafontes", text: "Comecei a desconfiar de qualquer resposta de IA sobre segurança, sempre confiro a fonte." },
      { user: "Vinicius Prado", handle: "viniciusprado", text: "Pair programming com IA mudou completamente como eu resolvo bug difícil às 2h da manhã." },
    ],
  },
  {
    id: "web",
    ...
    posts: [
      ...
      { user: "Diego Martins", handle: "diegomartins", text: "Migrei pra Server Components e o build ficou mais rápido, mas a curva de aprendizado assustou o time." },
      { user: "Larissa Melo", handle: "larissamelo", text: "Acessibilidade continua sendo o ponto mais esquecido nos projetos que eu vejo por aí." },
      { user: "Gustavo Pires", handle: "gustavopires", text: "Virei fã de CSS puro de novo depois que aprendi container queries." },
      { user: "Juliana Costa", handle: "julianacosta", text: "Framework novo toda semana cansa, prefiro dominar bem uma stack só." },
      { user: "Otávio Lins", handle: "otaviolins", text: "Web Components finalmente ficaram maduros o suficiente pra usar em produção." },
      { user: "Tatiana Souza", handle: "tatianasouza", text: "Dark mode bem feito dá mais trabalho do que parece, ninguém testa contraste direito." },
      { user: "Marcos Vidal", handle: "marcosvidal", text: "Trocamos Redux por Context e o código ficou muito mais simples de entender." },
      { user: "Renata Campos", handle: "renatacampos", text: "Performance no mobile continua sendo o maior gap entre design e produção." },
      { user: "Henrique Barros", handle: "henriquebarros", text: "SSR resolveu nosso problema de SEO, mas complicou o cache de página." },
    ],
  },
  {
    id: "backend",
    ...
    posts: [
      ...
      { user: "Renata Alves", handle: "renataalves", text: "Rate limit bem configurado evitou um incidente sério na Black Friday passada." },
      { user: "Marcelo Souza", handle: "marcelosouza", text: "Ainda prefiro monólito bem organizado do que microsserviço cedo demais." },
      { user: "Priscila Ramos", handle: "priscilaramos", text: "Métricas de latência por rota mudaram completamente como eu priorizo otimização." },
      { user: "Eduardo Braga", handle: "eduardobraga", text: "Migrei um serviço pra Go só pra reduzir uso de memória e valeu muito a pena." },
      { user: "Vagner Souto", handle: "vagnersouto", text: "Circuit breaker salvou nossa API numa queda de fornecedor externo semana passada." },
      { user: "Aline Ferreira", handle: "alineferreira", text: "Testei GraphQL no lugar de REST e o time levou um tempo pra se acostumar com resolvers." },
      { user: "Diego Nogueira", handle: "diegonogueira", text: "Banco de dados mal indexado ainda é a causa mais comum de lentidão que eu vejo em revisão de código." },
      { user: "Sofia Andrade", handle: "sofiaandrade", text: "Idempotência em endpoint de pagamento evitou cobrança duplicada em produção." },
      { user: "Leandro Farias", handle: "leandrofarias", text: "Prefiro escrever menos abstração e mais função pura, fica muito mais fácil de testar." },
    ],
  },
  {
    id: "cloud",
    ...
    posts: [
      ...
      { user: "Sabrina Teles", handle: "sabrinateles", text: "Terraform salvou meu time de recriar ambiente na mão depois de um incidente." },
      { user: "Rodrigo Farias", handle: "rodrigofarias", text: "Custo de cloud mal monitorado surpreende no fim do mês, ninguém fala disso o suficiente." },
      { user: "Camila Duarte", handle: "camiladuarte", text: "Deploy azul-verde reduziu nosso tempo de rollback de minutos pra segundos." },
      { user: "Bruno Castro", handle: "brunocastro", text: "Ainda acho containers complicados demais pra times pequenos que não precisam de escala." },
      { user: "Patricia Lemos", handle: "patricialemos", text: "Autoscaling mal configurado quase dobrou nosso custo num pico de tráfego inesperado." },
      { user: "Gabriel Xavier", handle: "gabrielxavier", text: "CI/CD com preview automático por PR mudou completamente a velocidade de revisão do time." },
      { user: "Bianca Moura", handle: "biancamoura", text: "Multi-cloud parece ótimo no papel, mas a complexidade operacional não compensa pra time pequeno." },
      { user: "Fábio Correia", handle: "fabiocorreia", text: "Backup automatizado testado de verdade (com restore de teste) evitou perda de dado real." },
      { user: "Luana Ribeiro", handle: "luanaribeiro", text: "Observabilidade com tracing distribuído foi o que mais ajudou a achar gargalo entre serviços." },
    ],
  },
  {
    id: "mobile",
    ...
    posts: [
      ...
      { user: "Leo Andrade", handle: "leoandrade", text: "Testar em dispositivo físico continua revelando bugs que o emulador nunca mostra." },
      { user: "Fernanda Cruz", handle: "fernandacruz", text: "Push notification mal configurada é a reclamação número um dos meus usuários." },
      { user: "Igor Peixoto", handle: "igorpeixoto", text: "Migrar pra Compose/SwiftUI valeu a pena, mas subestimei o tempo de reescrita." },
      { user: "Paula Vieira", handle: "paulavieira", text: "App ficar rápido no wifi da empresa e lento no 4G do usuário é clássico e ninguém testa isso." },
      { user: "Danilo Rocha", handle: "danilorocha", text: "Deep link quebrado depois de atualização de SO ainda é o bug mais chato de rastrear." },
      { user: "Carla Nunes", handle: "carlanunes", text: "React Native com Fabric resolveu boa parte da lentidão que a gente sentia em lista grande." },
      { user: "Wagner Melo", handle: "wagnermelo", text: "Bateria consumida em segundo plano ainda é o motivo número um de desinstalação que a gente vê nos reviews." },
      { user: "Beatriz Lopes", handle: "beatrizlopes", text: "App só em português perdeu usuário que a gente nem sabia que existia até localizar em inglês." },
      { user: "Samuel Duarte", handle: "samuelduarte", text: "Testar update em rollout gradual evitou um bug crítico chegar em todo mundo de uma vez." },
    ],
  },
];
